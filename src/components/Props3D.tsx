...
import { CAR_M, G, PROP_M, mat } from "@/lib/three-assets";
...
export function StreetLamp({
  ...
  return (
    <group position={position} rotation={[0, rotation, 0]}>
      <mesh geometry={G.cyl8} material={PROP_M.metal} position={[0, 0.18, 0]} scale={[0.55, 0.36, 0.55]} />
      <mesh geometry={G.cyl8} material={PROP_M.pole} position={[0, 3.4, 0]} scale={[0.28, 6.8, 0.28]} />
      <mesh
        geometry={G.cyl8}
...
export function StreetSign({ position }: { position: [number, number, number] }) {
  return (
    <group position={position}>
      <mesh geometry={G.cyl8} material={PROP_M.pole} position={[0, 1.7, 0]} scale={[0.14, 3.4, 0.14]} />
      <mesh
        geometry={G.softS}
...
export function TrafficSign({
  ...
  return (
    <group position={position} rotation={[0, rotation, 0]}>
      <mesh geometry={G.cyl8} material={PROP_M.pole} position={[0, 1.15, 0]} scale={[0.11, 2.3, 0.11]} />
      {kind === "stop" ? (
        <mesh
          geometry={G.cyl}
          material={m}
...
export function TrashBin({ position }: { position: [number, number, number] }) {
  return (
    <group position={position}>
      <mesh geometry={G.cyl} material={PROP_M.metal} position={[0, 0.45, 0]} scale={[0.6, 0.9, 0.6]} />
      <mesh geometry={G.cyl} material={PROP_M.pole} position={[0, 0.95, 0]} scale={[0.68, 0.1, 0.68]} />
    </group>
  );
}
